...
![Status](https://img.shields.io/badge/version-2.6.3-green)
...
1. Download `SmartPlayCue-v2.6.3-win64.zip` (portátil) ou `SmartPlayCue-Setup-2.6.3.exe` (instalador) from [Releases](../../releases)
