...
![Status](https://img.shields.io/badge/version-2.6.5-green)
...
1. Download `SmartPlayCue-v2.6.5-win64.zip` (portátil) ou `SmartPlayCue-Setup-2.6.5.exe` (instalador) from [Releases](../../releases)
...
- Module: `companion-module-smartplaycue/` — na release: **`Companion-Module-Smart.Play.Cue-v2.6.2.tgz`**
  (único ficheiro do módulo; importar no Companion e reiniciar — aparece como
  "Smart Play Cue" em Connections → Add connection)
