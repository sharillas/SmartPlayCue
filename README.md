...
![Status](https://img.shields.io/badge/version-2.6.7-green)
...
1. Download `SmartPlayCue-v2.6.7-win64.zip` (portátil) ou `SmartPlayCue-Setup-2.6.7.exe` (instalador) from [Releases](../../releases)
